...
function start() {
    ...
    cNormals = calculateGouraudNormals(mainCube);
    cfNormals = calculateFlatNormals(mainCube);
    pNormals = calculateGouraudNormals(wallPlane);
    pfNormals = calculateFlatNormals(wallPlane);
    sNormals = calculateGouraudNormals(pointsArray);
    sfNormals = calculateFlatNormals(pointsArray);
...
/**
 * Given a series of points, calculates normals for
 * FLAT shading simulation.
 *
 * @param points the given point array
 * @returns {Array}
 */
function calculateFlatNormals(points) {
    normalsArray = [];
...
/**
 * Given a series of points, calculates normals for Gouraud
 * shading simulation.
 *
 * @param points the given point array
 * @returns {Array}
 */
function calculateGouraudNormals(points) {
    normalsArray = [];
